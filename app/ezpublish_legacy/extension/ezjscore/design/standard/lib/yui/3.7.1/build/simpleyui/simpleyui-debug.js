...
}, '3.7.1', {"requires": ["dom-base", "dom-style"]});
...
}, '3.7.1', {"requires": ["node-base", "event-delegate"]});
...
}, '3.7.1', {"requires": ["node-base", "pluginhost"]});
...
}, '3.7.1', {"requires": ["dom-screen", "node-base"]});
...
}, '3.7.1', {"requires": ["dom-style", "node-base"]});
...
}, '3.7.1', {"use": ["yui", "oop", "dom", "event-custom-base", "event-base", "pluginhost", "node", "event-delegate", "io-base", "json-parse", "transition", "selector-css3", "dom-style-ie", "querystring-stringify-simple"]});
var Y = YUI().use('*');
