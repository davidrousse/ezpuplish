 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 3422);
YUITest.ShouldError = function (message){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "ShouldError", 3422);
_yuitest_coverline("build/test/test.js", 3425);
...
//inherit from YUITest.AssertionError
_yuitest_coverline("build/test/test.js", 3437);
YUITest.ShouldError.prototype = new YUITest.AssertionError();

//restore constructor
_yuitest_coverline("build/test/test.js", 3440);
 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 3452);
YUITest.ShouldFail = function (message){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "ShouldFail", 3452);
_yuitest_coverline("build/test/test.js", 3455);
...
//inherit from YUITest.AssertionError
_yuitest_coverline("build/test/test.js", 3467);
YUITest.ShouldFail.prototype = new YUITest.AssertionError();

//restore constructor
_yuitest_coverline("build/test/test.js", 3470);
 ...
 * @constructor
 */  
_yuitest_coverline("build/test/test.js", 3484);
YUITest.UnexpectedError = function (cause){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "UnexpectedError", 3484);
_yuitest_coverline("build/test/test.js", 3487);
...
//inherit from YUITest.AssertionError
_yuitest_coverline("build/test/test.js", 3513);
YUITest.UnexpectedError.prototype = new YUITest.AssertionError();

//restore constructor
_yuitest_coverline("build/test/test.js", 3516);
 ...
 * @constructor
 */ 
_yuitest_coverline("build/test/test.js", 3531);
YUITest.UnexpectedValue = function (message, unexpected){

    //call superclass
    _yuitest_coverfunc("build/test/test.js", "UnexpectedValue", 3531);
_yuitest_coverline("build/test/test.js", 3534);
YUITest.AssertionError.call(this, message);
...
//inherit from YUITest.AssertionError
_yuitest_coverline("build/test/test.js", 3553);
YUITest.UnexpectedValue.prototype = new YUITest.AssertionError();

//restore constructor
_yuitest_coverline("build/test/test.js", 3556);
...
YUITest.UnexpectedValue.prototype.getMessage = function(){
    _yuitest_coverfunc("build/test/test.js", "getMessage", 3564);
_yuitest_coverline("build/test/test.js", 3565);
 ...
 *
 */
_yuitest_coverline("build/test/test.js", 3579);
YUITest.Wait = function (segment, delay) {
     ...
     * @property segment
     */
    _yuitest_coverfunc("build/test/test.js", "Wait", 3579);
...
Y.Object.each(YUITest, function(item, name) {
    _yuitest_coverfunc("build/test/test.js", "(anonymous 14)", 3599);
_yuitest_coverline("build/test/test.js", 3600);
var name = name.replace('Test', '');
    _yuitest_coverline("build/test/test.js", 3601);
Y.Test[name] = item;
});
...
Y.Test.ArrayAssert.itemsAreEqual = function(expected, actual, message) {
    _yuitest_coverfunc("build/test/test.js", "itemsAreEqual", 3618);
...
Y.assert = function(condition, message){
    _yuitest_coverfunc("build/test/test.js", "assert", 3632);
_yuitest_coverline("build/test/test.js", 3633);
Y.Assert._increment();
    _yuitest_coverline("build/test/test.js", 3634);
if (!condition){
        _yuitest_coverline("build/test/test.js", 3635);
 ...
 * @static
 */
_yuitest_coverline("build/test/test.js", 3646);
Y.fail = Y.Assert.fail; 

_yuitest_coverline("build/test/test.js", 3648);
...
Y.Test.Runner.disableLogging = function() {
    _yuitest_coverfunc("build/test/test.js", "disableLogging", 3650);
_yuitest_coverline("build/test/test.js", 3651);
Y.Test.Runner._log = false;
};

_yuitest_coverline("build/test/test.js", 3654);
Y.Test.Runner.enableLogging = function() {
    _yuitest_coverfunc("build/test/test.js", "enableLogging", 3654);
...
_yuitest_coverline("build/test/test.js", 3659);
Y.Test.Runner._log = true;
...
var logEvent = function(event) {
        ...
        //data variables
        _yuitest_coverfunc("build/test/test.js", "logEvent", 3674);
_yuitest_coverline("build/test/test.js", 3677);
var message = "";
        _yuitest_coverline("build/test/test.js", 3678);
var messageType = "";
...
break;
            ...
            case this.TEST_SUITE_COMPLETE_EVENT:
                _yuitest_coverline("build/test/test.js", 3716);
...
break;
            ...
            case this.TEST_CASE_COMPLETE_EVENT:
                _yuitest_coverline("build/test/test.js", 3730);
...
message = "Unexpected event " + event.type;
                _yuitest_coverline("build/test/test.js", 3739);
message = "info";
        }
...
Y.log(message, messageType, "TestRunner");
    ...
    _yuitest_coverline("build/test/test.js", 3747);
var i, name;
...
if (i.indexOf('_EVENT') > -1) {
            _yuitest_coverline("build/test/test.js", 3752);
...
}, '3.7.1', {"requires": ["event-simulate", "event-custom", "json-stringify"]});
