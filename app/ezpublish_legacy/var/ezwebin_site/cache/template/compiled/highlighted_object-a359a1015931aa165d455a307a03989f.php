...
// Filename:  extension/ezwebin/design/ezwebin/override/templates/embed/highlighted_object.tpl
// Timestamp: 1350735749 (Sat Oct 20 12:22:29 UTC 2012)
$oldSetArray_f071ef41b62c432ca9769db884fb2ad2 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '<div class="border-box box-2">
...
$setArray = $oldSetArray_f071ef41b62c432ca9769db884fb2ad2;
$tpl->Level--;
?>
