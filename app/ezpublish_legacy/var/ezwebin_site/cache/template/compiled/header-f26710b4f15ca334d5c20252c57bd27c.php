...
$oldSetArray_e8faf55b1c2d590eeec2ccf8c43b3a46 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $if_cond1 );
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'anchor_name', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['anchor_name'] : null;
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'anchor_name', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['anchor_name'] : null;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'toc_anchor_name', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['toc_anchor_name'] : null;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
unset( $var );
unset( $var );
$var = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'level', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['level'] : null;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
unset( $match );
unset( $match );
$match = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'level', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['level'] : null;
...
$setArray = $oldSetArray_e8faf55b1c2d590eeec2ccf8c43b3a46;
$tpl->Level--;
?>
