...
$oldSetArray_7159feac80cc8b68e5afb86c58ae711b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '><span class="text">&laquo;&nbsp;Précédent</span></a></span>
       ';
    } break;
    default:
    {
$text .= '      <span class="previous"><span class="text disabled">&laquo;&nbsp;Précédent</span></span>
       ';
    } break;
}
unset( $match );
...
$text .= '><span class="text">Suivant&nbsp;&raquo;</span></a></span>
      ';
    } break;
    default:
    {
$text .= '        <span class="next"><span class="text disabled">Suivant&nbsp;&raquo;</span></span>
      ';
    } break;
}
unset( $match );
...
$setArray = $oldSetArray_7159feac80cc8b68e5afb86c58ae711b;
$tpl->Level--;
?>
