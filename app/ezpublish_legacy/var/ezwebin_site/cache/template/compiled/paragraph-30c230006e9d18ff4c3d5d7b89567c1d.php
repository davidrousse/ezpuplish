...
$oldSetArray_17dacd513044cb065981bf9ffb0c1032 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $if_cond1 );
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'classification', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['classification'] : null;
if (! isset( $if_cond1 ) ) $if_cond1 = NULL;
while ( is_object( $if_cond1 ) and method_exists( $if_cond1, 'templateValue' ) )
    $if_cond1 = $if_cond1->templateValue();
$strlenFunc = 'mb_strlen'; $substrFunc = 'mb_substr';
$if_cond = trim( $if_cond1 );
unset( $if_cond1 );
...
$setArray = $oldSetArray_17dacd513044cb065981bf9ffb0c1032;
$tpl->Level--;
?>
