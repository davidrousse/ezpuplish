...
// Filename:  extension/ezwebin/design/ezwebin/override/templates/embed/article.tpl
// Timestamp: 1350735749 (Sat Oct 20 12:22:29 UTC 2012)
$oldSetArray_ba9c6aaf272659b57f73189e59299442 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$tpl->processFunction( 'attribute_view_gui', $textElements,
  ...
  2 => 'extension/ezwebin/design/ezwebin/override/templates/embed/article.tpl',
),
...
unset( $if_cond1 );
$if_cond1 = $if_cond2;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'intro' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
...
$setArray = $oldSetArray_ba9c6aaf272659b57f73189e59299442;
$tpl->Level--;
?>
