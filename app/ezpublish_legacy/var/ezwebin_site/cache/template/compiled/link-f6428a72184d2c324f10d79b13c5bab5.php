<?php
// URI:       extension/ezwebin/design/ezwebin/templates/link.tpl
// Filename:  extension/ezwebin/design/ezwebin/templates/link.tpl
// Timestamp: 1350735749 (Sat Oct 20 12:22:29 UTC 2012)
$oldSetArray_3d5be562802d76ab8fc7a6c365091b3c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<link rel="Home" href="/ezpublish/app/ezpublish_legacy/index.php/fre" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'Page d\'accueil de %sitetitle', $var4 );
...
$text .= '" />
<link rel="Index" href="/ezpublish/app/ezpublish_legacy/index.php/fre" />
<link rel="Top"  href="/ezpublish/app/ezpublish_legacy/index.php/fre" title="';
unset( $var );
unset( $var );
...
$text .= '" />
<link rel="Search" href="/ezpublish/app/ezpublish_legacy/index.php/fre/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'Recherche %sitetitle', $var4 );
unset( $var3, $var4, $var5, $var6 );
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
...
$text .= '" />
<link rel="Shortcut icon" href="/ezpublish/app/ezpublish_legacy/design/standard/images/favicon.ico" type="image/x-icon" />
<link rel="Copyright" href="/ezpublish/app/ezpublish_legacy/index.php/fre/ezinfo/copyright" />
<link rel="Author" href="/ezpublish/app/ezpublish_legacy/index.php/fre/ezinfo/about" />
';
// if begins
unset( $if_cond );
unset( $if_cond1 );
unset( $if_cond2 );
unset( $if_cond2 );
$if_cond2 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
unset( $if_cond2 );
$if_cond2 = $if_cond3;
$if_cond3 = compiledFetchAttribute( $if_cond2, 'rss_feed' );
unset( $if_cond2 );
$if_cond2 = $if_cond3;
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'rss_feed' );
unset( $var1 );
$var1 = $var2;
...
$setArray = $oldSetArray_3d5be562802d76ab8fc7a6c365091b3c;
$tpl->Level--;
?>
