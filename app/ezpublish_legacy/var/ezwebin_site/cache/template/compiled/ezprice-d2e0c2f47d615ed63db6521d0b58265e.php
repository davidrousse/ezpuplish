...
// Filename:  extension/ezwebin/design/ezwebin/templates/content/datatype/view/ezprice.tpl
// Timestamp: 1350735749 (Sat Oct 20 12:22:29 UTC 2012)
$oldSetArray_981e755986b5f77f09bd6521a3f45cf6 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '<span class="old-price">Prix: ';
unset( $var );
...
$text .= '</span> <br />
<span class="new-price">Votre prix: ';
unset( $var );
// l10nTransformation begin
$locale = eZLocale::instance();
// l10nTransformation: static
...
$text .= '</span><br />
<span class="discount-percent">Vous économisez: ';
unset( $var );
// l10nTransformation begin
$locale = eZLocale::instance();
// l10nTransformation: static
...
unset( $var2 );
$var2 = $var3;
$var3 = compiledFetchAttribute( $var2, 'inc_vat_price' );
unset( $var2 );
$var2 = $var3;
if (! isset( $var2 ) ) $var2 = NULL;
while ( is_object( $var2 ) and method_exists( $var2, 'templateValue' ) )
...
unset( $var3 );
$var3 = $var4;
$var4 = compiledFetchAttribute( $var3, 'discount_price_inc_vat' );
unset( $var3 );
$var3 = $var4;
if (! isset( $var3 ) ) $var3 = NULL;
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
...
$setArray = $oldSetArray_981e755986b5f77f09bd6521a3f45cf6;
$tpl->Level--;
?>
