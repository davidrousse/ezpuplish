...
$oldSetArray_e0e76d7b11ecff924c53dbd4b8e72b6b = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $if_cond1 );
$if_cond1 = $if_cond2;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'tag_cloud_url' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'data_text' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'tag_cloud_url' );
unset( $var1 );
$var1 = $var2;
...
unset( $if_cond1 );
$if_cond1 = $if_cond2;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'site_map_url' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'data_text' );
unset( $if_cond1 );
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'site_map_url' );
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'data_text' );
unset( $var1 );
...
if ( $if_cond )
{
$text .= '        <li id="shoppingbasket"><a href="/ezpublish/app/ezpublish_legacy/index.php/fre/shop/basket" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'shopping_basket_label' );
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'data_text' );
unset( $var1 );
...
unset( $if_cond );
$if_cond = $if_cond1;
$if_cond1 = compiledFetchAttribute( $if_cond, 'my_profile_label' );
unset( $if_cond );
$if_cond = $if_cond1;
...
if ( $if_cond )
{
$text .= '        <li id="myprofile"><a href="/ezpublish/app/ezpublish_legacy/index.php/fre/user/edit" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'my_profile_label' );
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'data_text' );
unset( $var1 );
...
unset( $if_cond );
$if_cond = $if_cond1;
$if_cond1 = compiledFetchAttribute( $if_cond, 'logout_label' );
unset( $if_cond );
$if_cond = $if_cond1;
$if_cond1 = compiledFetchAttribute( $if_cond, 'has_content' );
unset( $if_cond );
...
if ( $if_cond )
{
$text .= '        <li id="logout"><a href="/ezpublish/app/ezpublish_legacy/index.php/fre/user/logout" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'logout_label' );
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'data_text' );
unset( $var1 );
...
unset( $if_cond1 );
$if_cond1 = $if_cond2;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'register_user_label' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
...
if ( $if_cond )
{
$text .= '        <li id="registeruser"><a href="/ezpublish/app/ezpublish_legacy/index.php/fre/user/register" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'register_user_label' );
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'data_text' );
unset( $var1 );
...
unset( $if_cond );
$if_cond = $if_cond1;
$if_cond1 = compiledFetchAttribute( $if_cond, 'login_label' );
unset( $if_cond );
$if_cond = $if_cond1;
$if_cond1 = compiledFetchAttribute( $if_cond, 'has_content' );
unset( $if_cond );
...
if ( $if_cond )
{
$text .= '        <li id="login"><a href="/ezpublish/app/ezpublish_legacy/index.php/fre/user/login" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'login_label' );
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'data_text' );
unset( $var1 );
...
if ( $if_cond )
{
$text .= '        <li id="sitesettings"><a href=';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var3 );
$var3 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'site_settings_label' );
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'data_text' );
unset( $var1 );
...
$setArray = $oldSetArray_e0e76d7b11ecff924c53dbd4b8e72b6b;
$tpl->Level--;
?>
