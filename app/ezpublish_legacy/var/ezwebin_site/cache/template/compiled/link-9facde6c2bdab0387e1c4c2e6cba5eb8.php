...
$oldSetArray_d32f7363412cd1f2014c1037c925946e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<link rel="Home" href="/ezpublish/app/ezpublish_legacy/index.php/ezwebin_site_admin" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$var1 = strtr( 'Page de garde %sitetitle', $var4 );
...
$text .= '" />
<link rel="Index" href="/ezpublish/app/ezpublish_legacy/index.php/ezwebin_site_admin" />
<link rel="Top"  href="/ezpublish/app/ezpublish_legacy/index.php/ezwebin_site_admin" title="';
unset( $var );
unset( $var );
...
$text .= '" />
<link rel="Search" href="/ezpublish/app/ezpublish_legacy/index.php/ezwebin_site_admin/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
<link rel="Copyright" href="/ezpublish/app/ezpublish_legacy/index.php/ezwebin_site_admin/ezinfo/copyright" />
<link rel="Author" href="/ezpublish/app/ezpublish_legacy/index.php/ezwebin_site_admin/ezinfo/about" />
';
// if begins
unset( $if_cond );
unset( $if_cond );
...
$setArray = $oldSetArray_d32f7363412cd1f2014c1037c925946e;
$tpl->Level--;
?>
