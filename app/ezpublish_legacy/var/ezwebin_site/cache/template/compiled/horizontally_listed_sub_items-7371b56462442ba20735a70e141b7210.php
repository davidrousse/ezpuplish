...
// Filename:  extension/ezwebin/design/ezwebin/override/templates/embed/horizontally_listed_sub_items.tpl
// Timestamp: 1350735749 (Sat Oct 20 12:22:29 UTC 2012)
$oldSetArray_60978dae5687c7cd330616a8b678343e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'children', $rootNamespace ) )
{
  ...
  2 => 'extension/ezwebin/design/ezwebin/override/templates/embed/horizontally_listed_sub_items.tpl',
) );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezwebin_site/cache/template/compiled/article-a938d1dfa6ce2faff2383b820a450954.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'extension/ezwebin/design/ezwebin/override/templates/horizontallylistedsubitems/article.tpl' );
include( '' . 'var/ezwebin_site/cache/template/compiled/article-a938d1dfa6ce2faff2383b820a450954.php' );
...
$tpl->processURI( 'extension/ezwebin/design/ezwebin/override/templates/horizontallylistedsubitems/article.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezwebin_site/cache/template/compiled/event-7c847234998ac45b2a1e925e79f2f51b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'extension/ezwebin/design/ezwebin/override/templates/horizontallylistedsubitems/event.tpl' );
include( '' . 'var/ezwebin_site/cache/template/compiled/event-7c847234998ac45b2a1e925e79f2f51b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'extension/ezwebin/design/ezwebin/override/templates/horizontallylistedsubitems/event.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezwebin_site/cache/template/compiled/image-f1bc1037d0854902a3675f54cd1f9e56.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'extension/ezwebin/design/ezwebin/override/templates/horizontallylistedsubitems/image.tpl' );
include( '' . 'var/ezwebin_site/cache/template/compiled/image-f1bc1037d0854902a3675f54cd1f9e56.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'extension/ezwebin/design/ezwebin/override/templates/horizontallylistedsubitems/image.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezwebin_site/cache/template/compiled/product-6def5b1e367fc4fe506ca54bc2c68317.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'NodeView' : ( $currentNamespace . ':' . 'NodeView' );
$tpl->createLocalVariablesList();
$tpl->appendTemplateFetch( 'extension/ezwebin/design/ezwebin/override/templates/horizontallylistedsubitems/product.tpl' );
include( '' . 'var/ezwebin_site/cache/template/compiled/product-6def5b1e367fc4fe506ca54bc2c68317.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'extension/ezwebin/design/ezwebin/override/templates/horizontallylistedsubitems/product.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$textElements = array();
$extraParameters = array();
$tpl->processURI( 'extension/ezwebin/design/ezwebin/override/templates/node/view/horizontallylistedsubitems.tpl', true, $extraParameters, $textElements, $rootNamespace, $currentNamespace );
$text .= implode( '', $textElements );
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
...
unset( $if_cond1 );
$if_cond1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'children', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['children'] : null;
$if_cond2 = compiledFetchAttribute( $if_cond1, 2 );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
if (! isset( $if_cond1 ) ) $if_cond1 = NULL;
while ( is_object( $if_cond1 ) and method_exists( $if_cond1, 'templateValue' ) )
...
$setArray = $oldSetArray_60978dae5687c7cd330616a8b678343e;
$tpl->Level--;
?>
