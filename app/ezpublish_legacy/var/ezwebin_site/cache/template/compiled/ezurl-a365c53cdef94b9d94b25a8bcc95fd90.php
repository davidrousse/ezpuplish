<?php
// URI:       design:content/datatype/edit/ezurl.tpl
// Filename:  design/standard/templates/content/datatype/edit/ezurl.tpl
// Timestamp: 1349721948 (Mon Oct 8 18:45:48 UTC 2012)
$oldSetArray_c2254ec845394f3332630e86d3080c38 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $tpl->hasVariable( 'id_base', $rootNamespace ) )
{
  ...
  2 => 'design/standard/templates/content/datatype/edit/ezurl.tpl',
) );
...
$setArray = $oldSetArray_c2254ec845394f3332630e86d3080c38;
$tpl->Level--;
?>
